 ...
 * For React Native, this will be handled by the Image component's onError prop
 */
...
/**
 * Optimize image URL for React Native
 */
 ...
 */
export const getImageDimensions = (category: 'bar' | 'event' | 'drink', size: 'small' | 'medium' | 'large') => {
  const dimensions = {
